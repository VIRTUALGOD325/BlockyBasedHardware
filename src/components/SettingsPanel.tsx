...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    <div className="h-full flex flex-col bg-[#1a1d27] border-l border-white/5 text-white">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-[#1e2130]">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        {/* ── Project Section ── */}
        <section>
          <h3 className="text-[10px] font-bold text-white/40 uppercase tracking-[0.15em] mb-3">
            Project
          </h3>
          <div className="space-y-2">
            <button
              onClick={onNewProject}
              className="flex items-center gap-2 w-full px-3 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white/70 hover:bg-white/10 hover:text-white/90 transition-colors text-[12px] font-medium"
            >
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              <label className="flex items-center gap-1.5 text-[11px] font-medium text-white/60">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-[12px] text-white/90 focus:outline-none focus:border-indigo-500/50 transition-colors cursor-pointer hover:bg-white/[0.07]"
                >
            ...
            <div className="flex items-center justify-between py-1">
              ...
              <button
                ...
                className={`relative w-9 h-5 rounded-full transition-colors ${
                  settings.autoConnect ? "bg-indigo-500" : "bg-white/10"
                }`}
              >
                <span
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-1">
              ...
              <button
                ...
                className={`relative w-9 h-5 rounded-full transition-colors ${
                  settings.autoScrollConsole ? "bg-indigo-500" : "bg-white/10"
                }`}
              >
                <span
                  className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow transition-transform ${
        ...
        <section>
          ...
          <button
            ...
            className="flex items-center gap-2 w-full px-3 py-2.5 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 transition-colors text-[12px] font-medium"
          >
