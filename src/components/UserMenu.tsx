  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-[12px] font-medium text-white/70 max-w-[100px] truncate hidden sm:block">
          {user.name}
        </span>
        <ChevronDown
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 top-full mt-1.5 z-[151] w-56 bg-[#1e2130] border border-white/10 rounded-xl shadow-2xl overflow-hidden">
            {/* User info */}
            ...
            <div className="p-1.5">
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-[12px] font-medium text-red-400 hover:bg-red-500/10 transition-colors"
              >
